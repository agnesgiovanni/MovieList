    ...
    <nav class="navbar navbar-expand-lg" style="background-color: #323233;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link text-white" aria-current="page" href="<?php echo e(url('/')); ?>">Home</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <?php if(strcmp("Auth::user()->role", "" == 0)): ?>
                    ...
                    <?php elseif(strcmp("Auth::user()->role", "user" == 0)): ?>
                    <li class="nav-item">
...
</html><?php /**PATH C:\Users\AgnesGW\Documents\laravel-workspace\ProjectWebProgLab-MovieList\resources\views/master.blade.php ENDPATH**/ ?>