...
<div class="container">
  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="true">
    ...
    <div class="carousel-inner">
      <?php $__currentLoopData = $movies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      ">
        ...
        <div class="carousel-caption d-none d-md-block">
          <p><?php echo e($b->genre . ' | ' . date('Y', strtotime($b->release_date))); ?> </p>
        ...
        <form class="d-flex" action="<?php echo e('/addWathclist'); ?>">
  ...
  <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner-genre">
      <?php $__currentLoopData = $movies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <button type="button" class="btn btn-light genre-choice me-2"><?php echo e($g->genre); ?></button>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
<div id="sort-navbar" class="body-container"> 
  ...
  <form class="d-flex" action="<?php echo e(url('/latest')); ?>">
    <button id="sort-latest" name="sort" type="submit" class="btn-sort me-2">Latest</button>
  </form>
  ...
  <form class="d-flex" action="<?php echo e('/insertMovie'); ?>">
    <button type="submit" class="btn btn-danger" id="btn-admin">
...
<div class="movie-list">
    <?php $__currentLoopData = $movies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="movie-list-item">
        ...
        <?php if(auth()->guard()->check()): ?>
        <?php if(Auth::user()->role == 'member'): ?>
          <button type="submit" class="btn btn-danger" id="btn-admin" action="<?php echo e('/watchlist'); ?>">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AgnesGW\Downloads\ProjectWebProgLab-MovieList\resources\views/home.blade.php ENDPATH**/ ?>