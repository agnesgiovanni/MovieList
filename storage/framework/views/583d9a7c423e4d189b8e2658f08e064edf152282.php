                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="admin-features">
                                <a href="edit-actor/"><i class="fa-solid fa-edit"></i></a>
                                <br>
                                <a href="#"><i class="fa-solid fa-trash-alt"></i></a>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\kuliah\Matkul semester 5\Web Proggramming\project\code\o\ProjectWebProgLab-MovieList2\resources\views/pages/actor/detailActor.blade.php ENDPATH**/ ?>