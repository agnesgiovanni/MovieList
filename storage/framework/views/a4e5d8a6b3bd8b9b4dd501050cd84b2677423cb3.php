                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="actor-name">
                                <a href="<?php echo e(url('/actor')); ?>/actor/<?php echo e($actor->actors->id); ?>"><?php echo e($actor->actors->name); ?></a>
                            </div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\kuliah\Matkul semester 5\Web Proggramming\project\code\s\ProjectWebProgLab-MovieList2\resources\views/pages/actor/actor.blade.php ENDPATH**/ ?>