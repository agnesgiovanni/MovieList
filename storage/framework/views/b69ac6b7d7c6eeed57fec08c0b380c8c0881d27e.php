    ...
    <nav class="navbar navbar-expand-lg" style="background-color: #323233;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link text-white" aria-current="page" href="<?php echo e(url('/home')); ?>">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo e(url('/movie')); ?>">Movie</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo e(url('/actor')); ?>">Actors</a>
                    </li>

                    <?php if(auth()->guard()->check()): ?>
                    <?php if(Auth::user()->role == 'member'): ?>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo e(url('/watchlist')); ?>">My Watchlist</a>
                    </li>
                    <li class="nav-item">
                        <div class="dropdown-center">
                            ...
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" href="<?php echo e(url('/profile')); ?>">Profile</a></li>
                              <li><a class="dropdown-item" href="<?php echo e(url('/logout')); ?>">Log Out</a></li>
                            </ul>
                          </div>
                    </li>
                    <?php endif; ?>
...
</html><?php /**PATH F:\kuliah\Matkul semester 5\Web Proggramming\project\code\s\ProjectWebProgLab-MovieList2\resources\views/master.blade.php ENDPATH**/ ?>